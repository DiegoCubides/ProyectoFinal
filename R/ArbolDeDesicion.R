...
datasetcopia <-read_csv(paste0(folder,"/Dataset_ambiente_prueba.csv"))#Lee el archivo de datos "Dataset_ambiente2.csv" utilizando la función, almacena opjeto ata objeto datacopia
